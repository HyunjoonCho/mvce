...
python vote.py -r ../results/HumanEval_qwen2.5-coder:32b_base.json
python vote.py -r ../results/HumanEval_qwen2.5-coder:32b_instruction.json
python vote.py -r ../results/HumanEval_qwen2.5-coder:32b_rule.json
